...
{
    public class RangoEdadesBusiness
    {
        private readonly IGenericDataRepository<CatRangoEdades> _repository;

        public RangoEdadesBusiness()
        {
            _repository = new GenericDataRepository<CatRangoEdades>();
        }

        public ApiResponse<IList<CatRangoEdades>> GetRangosEdades()
        {
            ApiResponse<IList<CatRangoEdades>> apiResponse = new ApiResponse<IList<CatRangoEdades>>();
